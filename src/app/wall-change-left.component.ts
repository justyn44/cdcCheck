...
@Component({
  ...
  template: `
    <div>
      <a style="cursor:pointer;" (click)="onSelect()"
        ><img src="/assets/images/icons/rotate-left.png"
      /></a>
    </div>
  `
})
export class wallChangeLeft {
  ...
  @Input() zidCurent: number;

  @Output() wallChangeLeftClicked: EventEmitter<number> = new EventEmitter<
    number
  >();
  ...
  onSelect(): any {
    ...
    console.log('component:' + this.zidCurent);
