    ...
    function ProductService() {
        this.ProductService = (function () {
            ...
            ProductService.prototype.convertXMLToJson = function (data) {
                ...
                xml2js_1.xml2js.a.parseString(data, { explicitArray: false }, function (error, result) {
                    if (error) {
            ...
            ProductService.prototype.convertToXml = function (rootObject) {
                return new xml2js_1.xml2js.a.Builder().buildObject(rootObject);
            };
            ;
            ProductService.prototype.getStyles = function (category) {
                var _this = this;
                var url = 'http://dev.summerwood.com/products/' + category + '/styles.xml';
                ...
                return this.http.get(url, { headers: headers })
                    .map(function (res) {
                    var data = _this.convertXMLToJson(res['_body']);
            ...
            ProductService.prototype.getProductConfiguration = function (id) {
                var _this = this;
                var url = 'http://dev.summerwood.com/products/configuration/' + id + '.xml';
                var headers = new http_1.Headers();
                return this.http.get(url, { headers: headers })
                    .map(function (res) {
                    var data = _this.convertXMLToJson(res['_body']);
            ...
            ProductService.prototype.getSidingOptions = function () {
                var options = [{ 'id': 1, 'name': 'Cedar', 'order_code': 'cedar3', 'opt_type': 'siding', 'thumbnail': '/assets/thumbnails/wall/horizontal/cedar-7x12.png' },
