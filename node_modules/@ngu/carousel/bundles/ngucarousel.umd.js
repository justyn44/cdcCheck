(function (global, factory) {
	...
	(factory((global.ng = global.ng || {}, global.ng.ngucarousel = global.ng.ngucarousel || {}),global.ng.common,global.ng.core));
...
var NguCarousel = /** @class */ (function () {
    ...
    NguCarousel.prototype.inputValidation = function () {
    ...
    NguCarousel.prototype.ngOnDestroy = function () {
        ...
        this.listener3 && this.listener3();
        this.listener4 && this.listener4();
        this.listener5 && this.listener5();
        this.listener6 && this.listener6();
        this.listener7 && this.listener7();
        this.listener8 && this.listener8();
    };
    ...
    NguCarousel.prototype.touch = function () {
        ...
        if (this.userData.touch) {
            ...
            hammertime.on('panend', function (ev) {
                if (Math.abs(ev.velocity) > _this.data.velocity) {
    ...
    NguCarousel.prototype.setTouchTransfrom = function (e, valt) {
        var condition = this.data.RTL ? 'panright' : 'panleft';
        this.data.touchTransform =
            e === condition
                ? valt + this.data.touchTransform
                : this.data.touchTransform - valt;
    };
    NguCarousel.prototype.setTransformFromTouch = function () {
        if (this.data.touchTransform < 0) {
            this.data.touchTransform = 0;
        }
        var type = this.data.type === 'responsive' ? '%' : 'px';
        this.setStyle(this.carouselInner, 'transform', this.data.vertical.enabled
            ? "translate3d(0, " + this.directionSym + this.data.touchTransform + type + ", 0)"
            : "translate3d(" + this.directionSym + this.data.touchTransform + type + ", 0, 0)");
    };
    ...
    NguCarousel.prototype.storeCarouselData = function () {
        this.data.deviceWidth = _angular_common.isPlatformBrowser(this.platformId)
            ? window.innerWidth
            : 1200;
    ...
    NguCarousel.prototype.moveTo = function (slide, withOutAnimation) {
        // slide = slide - 1;
        withOutAnimation && (this.withAnim = false);
        if (this.activeSlide !== slide && slide < this.pointIndex) {
            var slideremains = void 0;
            var btns = this.data.currentSlide < slide ? 1 : 0;
            switch (slide) {
                case 0:
                    this.btnBoolean(1, 0);
    ...
    NguCarousel.prototype.carouselSize = function () {
        ...
        if (this.data.vertical.enabled) {
            ...
            this.renderer.setStyle(this.carouselMain, 'height', this.data.vertical.height + "px");
        }
    ...
    NguCarousel.prototype.carouselInterval = function () {
        ...
        if (this.data.interval && this.data.loop) {
            ...
            setTimeout(function () {
                _this.carouselInt = setInterval(function () {
                    !_this.pauseCarousel && _this.carouselScrollOne(1);
                }, _this.userData.interval.timing);
    ...
    NguCarousel.decorators = [
        { type: _angular_core.Component, args: [{
                    ...
                    template: "<div #ngucarousel class=\"ngucarousel\"><div #nguitems class=\"ngucarousel-items\"><ng-content select=\"[NguCarouselItem]\"></ng-content></div><div class=\"nguclearFix\"></div><ng-content select=\"[NguCarouselPrev]\"></ng-content><ng-content select=\"[NguCarouselNext]\"></ng-content></div><ng-content select=\"[NguCarouselPoint]\"></ng-content>",
                    styles: [
